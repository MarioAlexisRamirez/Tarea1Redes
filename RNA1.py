...
net.SGD( training_data, 30, 10, 3.4, test_data=test_data)
...
net.compile(optimizer=optimizers.ADAM(learning_rate=0.001)) #hasta ahorita se va a ver la diferencia de esta linea
